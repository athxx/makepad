    ...
    mod.themes.light = {
        ...
        font_label: TextStyle{
            font_family: FontFamily{
                ...
                chinese := FontMember{res: system_font("cjk", 400, false) asc: 0.0 desc: 0.0}
                emoji := FontMember{res: system_font("emoji", 400, false) asc: 0.0 desc: 0.0}
            }
            line_spacing: 1.2
        ...
        font_bold: TextStyle{
            font_family: FontFamily{
                ...
                chinese := FontMember{res: system_font("cjk", 700, false) asc: 0.0 desc: 0.0}
                emoji := FontMember{res: system_font("emoji", 400, false) asc: 0.0 desc: 0.0}
            }
            line_spacing: 1.2
        }
