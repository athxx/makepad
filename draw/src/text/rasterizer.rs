...
impl Rasterizer {
    ...
    pub fn rasterize_glyph(
        ...
        // iOS/tvOS: `AppleColorEmoji` stores color bitmaps as the private `emjc`
        // sbix format the raster-image path can't decode. Draw via CoreText.
    ...
    */
    ...
    /// iOS/tvOS color emoji via CoreText's `CTFontDrawGlyphs`. Mirrors
